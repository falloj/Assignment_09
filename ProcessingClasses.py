...
# JFallon, 2022-Mar-27, added code to select cd, add tracks
#------------------------------------------#
...
class DataProcessor:
    ...
    def add_track(track_info: tuple, cd: DC.CD) -> None:
        ...
        # TODone add code as required
        # modeled this after the add_cd() function
        ...
        cd.cd_tracks.append(row)
        print('The track has been added to your CD.')
